...
def greetMe(): 
    ...
    if hour>=0 and hour<12:
        ...
        print("Everly: Hello and Good Afternoon! ")
        speak("Hello and Good Afternoon! ")
    else:
        print("Everly: Hello and Good Evening! ")
        speak("Hello and Good Evening!")
    
    # return react
def t():
     print("Everly :How are you doing today?")
     print("Happy \nSad \nJoyful \ndisappointed \nunhappy ")
...
def Gmail(said): #open mails from a person
...
def Drive(said): #open file from drive
        # search_term = said.split("file")[-1]
...
def Youtube(said):  #open anything from youtube
...
def weather(said):
        ...
        webbrowser.get().open(url)
        print("Everly: showing the current weather")
        speak("This the current weather")
...
def song(said): #play song on spotify web
...
# reminder function is saved in remind.py
def news():
    ...
    while True:
            ...
            if "hello" in text:
                  ...
                  speak("I have been created by a group of amazing humans.")
                    ...
                    Drive(text)   
            elif "what do i have" in text or "do i have any plan" in text or "am i busy" in text:
                date = get_date(text)
            ...
            #     remind.read_reminder()
                ...
                news()
            elif "sad" in text or "disappointed" in text or "unhappy" in text:
               print("I would like to know more about how you feel today! Could you please answer few questions for me? \n (YES/NO)")
               speak("I would like to know more about how you feel today!!!!! Could you please answer few questions for me? Please reply with yes or no")
               res = get_audio().lower()
               if res == "yes":
                  bot.therapy()
               if res=="no":
