...
def add_remind():
    wb = load_workbook("C:/Users/DELL/OneDrive/Desktop/everly/Book1.xlsx")
    ws=wb["Sheet1"]   
    ...
    wcell3 = ws.cell(i,3)
    wcell3.value=tt
    wb.save("C:/Users/DELL/OneDrive/Desktop/everly/Book1.xlsx")
    ...
    for i in range(2,row_count):
      ...
      if(td==t):
        if(tnow<=t1):
         ...
         print(about + " at " + t1)
         notification.notify(title='Reminder ' ,message=about + " at " + t1,app_icon=None,  timeout=5, )
